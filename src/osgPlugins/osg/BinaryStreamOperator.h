...
public:
	...
	//add by myself 2021 07 28 hxx
	virtual void readInt64(int64_t& value)
	{
		_in->read((char*)&value, osgDB::INT64_SIZE);
		if (_byteSwap) osg::swapBytes((char*)&value, osgDB::INT64_SIZE);
	}
