...
//added in 2021 07 28 to support osg::MatrixfArray MatrixdArray serializer
ARRAY_WRAPPERS(MatrixfArray, RW_MATRIXF, 1)
ARRAY_WRAPPERS(MatrixdArray, RW_MATRIXD, 1)

//added in 2021 07 28 to support vec int64/uint64 array serializer
ARRAY_WRAPPERS(Int64Array, RW_INT64, 4)
ARRAY_WRAPPERS(UInt64Array, RW_UINT64, 4)
ARRAY_WRAPPERS(Vec2i64Array, RW_VEC2I64, 1)
ARRAY_WRAPPERS(Vec2ui64Array, RW_VEC2UI64, 1)
ARRAY_WRAPPERS(Vec3i64Array, RW_VEC3I64, 1)
ARRAY_WRAPPERS(Vec3ui64Array, RW_VEC3UI64, 1)
ARRAY_WRAPPERS(Vec4i64Array, RW_VEC4I64, 1)
ARRAY_WRAPPERS(Vec4ui64Array, RW_VEC4UI64, 1)
//added in 2021 07 28 to support quat array serializer
ARRAY_WRAPPERS(QuatArray, RW_QUAT, 1)
