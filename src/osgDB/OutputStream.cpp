...
OutputStream& OutputStream::operator<<(const osg::Quat& q)
{
	*this << (osg::Quat::value_type)q.x() << (osg::Quat::value_type)q.y() << (osg::Quat::value_type)q.z() << (osg::Quat::value_type)q.w(); return *this;
}
...
OutputStream& OutputStream::operator<<(const osg::Plane& p)
{
	*this << (osg::Plane::value_type)p[0] << (osg::Plane::value_type)p[1] << (osg::Plane::value_type)p[2] << (osg::Plane::value_type)p[3]; return *this;
}
...
// hxx 2021 07 28 
OutputStream& OutputStream::operator<<(const osg::Vec2i64& v) { *this << v.x() << v.y(); return *this; }
OutputStream& OutputStream::operator<<(const osg::Vec2ui64& v) { *this << v.x() << v.y(); return *this; }
OutputStream& OutputStream::operator<<(const osg::Vec3i64& v) { *this << v.x() << v.y() << v.z(); return *this; }
OutputStream& OutputStream::operator<<(const osg::Vec3ui64& v) { *this << v.x() << v.y() << v.z(); return *this; }
OutputStream& OutputStream::operator<<(const osg::Vec4i64& v) { *this << v.x() << v.y() << v.z() << v.w(); return *this; }
OutputStream& OutputStream::operator<<(const osg::Vec4ui64& v) { *this << v.x() << v.y() << v.z() << v.w(); return *this; }

#if 1 // hxx 2021 07 28 , original is '0'
    ...
    *this << PROPERTY("ArrayID") << id;
    ...
    case osg::Array::Vec4dArrayType:
        *this << MAPPEE(ArrayType, ID_VEC4D_ARRAY);
        ...
        break;
     //add supports for MatrixfArrayType and MatrixdArrayType hxx 2024 07 28
	case osg::Array::MatrixfArrayType:
		*this << MAPPEE(ArrayType, ID_MATRIXF_ARRAY);
		writeArrayImplementation(static_cast<const osg::MatrixfArray*>(a), a->getNumElements());
		break;
	case osg::Array::MatrixdArrayType:
		*this << MAPPEE(ArrayType, ID_MATRIXD_ARRAY);
		writeArrayImplementation(static_cast<const osg::MatrixdArray*>(a), a->getNumElements());
		break;
	//add supports for QuatArrayType hxx 2024 07 28
	case osg::Array::QuatArrayType:
		*this << MAPPEE(ArrayType, ID_QUAT_ARRAY);
		writeArrayImplementation(static_cast<const osg::QuatArray*>(a), a->getNumElements());
		break;
	//add supports for int64/uint64 hxx 2024 07 28
	case osg::Array::UInt64ArrayType:
		*this << MAPPEE(ArrayType, ID_UINT64_ARRAY);
		writeArrayImplementation(static_cast<const osg::UInt64Array*>(a), a->getNumElements());
		break;
	case osg::Array::Int64ArrayType:
		*this << MAPPEE(ArrayType, ID_INT64_ARRAY);
		writeArrayImplementation(static_cast<const osg::Int64Array*>(a), a->getNumElements());
		break;
	case osg::Array::Vec2i64ArrayType:
		*this << MAPPEE(ArrayType, ID_VEC2I64_ARRAY);
		writeArrayImplementation(static_cast<const osg::Vec2i64Array*>(a), a->getNumElements());
		break;
	case osg::Array::Vec2ui64ArrayType:
		*this << MAPPEE(ArrayType, ID_VEC2UI64_ARRAY);
		writeArrayImplementation(static_cast<const osg::Vec2ui64Array*>(a), a->getNumElements());
		break;
	case osg::Array::Vec3i64ArrayType:
		*this << MAPPEE(ArrayType, ID_VEC3I64_ARRAY);
		writeArrayImplementation(static_cast<const osg::Vec3i64Array*>(a), a->getNumElements());
		break;
	case osg::Array::Vec3ui64ArrayType:
		*this << MAPPEE(ArrayType, ID_VEC3UI64_ARRAY);
		writeArrayImplementation(static_cast<const osg::Vec3ui64Array*>(a), a->getNumElements());
		break;
	case osg::Array::Vec4i64ArrayType:
		*this << MAPPEE(ArrayType, ID_VEC4I64_ARRAY);
		writeArrayImplementation(static_cast<const osg::Vec4i64Array*>(a), a->getNumElements());
		break;
	case osg::Array::Vec4ui64ArrayType:
		*this << MAPPEE(ArrayType, ID_VEC4UI64_ARRAY);
		writeArrayImplementation(static_cast<const osg::Vec4ui64Array*>(a), a->getNumElements());
		break;
